...
function AIQuickAdd({ user, onAuthRequired, onParsed }) {
    ...
    const handleSubmit = async ()=>{
        ...
        setLoading(true);
        setError("");
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAppwriteSessionToken"])();
        if (!token) {
            onAuthRequired();
            setLoading(false);
            return;
...
//# sourceMappingURL=_00t.~yo._.js.map