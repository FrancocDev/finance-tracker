...
async function getAuthenticatedUser(request) {
    ...
    try {
        const client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$appwrite$2f$dist$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Client"]().setEndpoint(APPWRITE_ENDPOINT).setProject(APPWRITE_PROJECT).setSession(sessionToken);
        const account = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$appwrite$2f$dist$2f$services$2f$account$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Account"](client);
...
"[project]/app/api/ai/report/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthenticatedUser"])(request);
    if (!user) {
    ...
    const limit = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reportLimiter"].consume(user.$id);
    if (!limit.allowed) {
    ...
    const sortedCategories = Object.entries(expenseByCategory).sort((a, b)=>b[1] - a[1]).map(([cat, amt])=>`${cat}: $${amt.toFixed(2)}`).join("\n");
...
- Expense Categories:\n${sortedCategories || "None"}`;
    try {
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["streamText"])({
            model: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$groq$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["groq"])("llama-3.3-70b-versatile"),
            system: systemPrompt,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06-ite0._.js.map